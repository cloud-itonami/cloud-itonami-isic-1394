# Operator Quickstart — Manufacture of cordage, rope, twine and netting

Shortest path from clone to a verified local dry-run for **ISIC 1394** (`cloud-itonami-isic-1394`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1394.git
cd cloud-itonami-isic-1394
```
...
- Blueprint governor key: `cordage-netting-plant-operations-governor`
- Likely source path: `cordageops.governor.cljc`
