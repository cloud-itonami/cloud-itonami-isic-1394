# Business Model: Manufacture of cordage, rope, twine and netting
...
## Classification
- Repository: `cloud-itonami-isic-1394` ([github.com/cloud-itonami/cloud-itonami-isic-1394](https://github.com/cloud-itonami/cloud-itonami-isic-1394))
- ISIC Rev.5: `1394` — Manufacture of cordage, rope, twine and netting
- Domain: `:textiles/cordage`
- Social impact: :worker-safety :labor-standards :materials-traceability
- Actor: `:cordage-netting-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :textiles/cordage — who wants
...
One managed tenant (:textiles/cordage):
...
- Do not bypass the `:cordage-netting-plant-operations-governor` for production decisions.
